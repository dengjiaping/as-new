...
public class SenderRLAdapter extends BaseQuickAdapter<MyReplyNoteBean.MyReplyBean, BaseViewHolder> {

    public SenderRLAdapter(@LayoutRes int layoutResId, @Nullable List<MyReplyNoteBean.MyReplyBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MyReplyNoteBean.MyReplyBean item) {
