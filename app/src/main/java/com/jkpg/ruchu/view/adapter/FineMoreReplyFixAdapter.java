...
public class FineMoreReplyFixAdapter extends BaseQuickAdapter<MoreReplyBean.ItemsBean, BaseViewHolder> {
    public FineMoreReplyFixAdapter(@LayoutRes int layoutResId, @Nullable List<MoreReplyBean.ItemsBean> data) {
