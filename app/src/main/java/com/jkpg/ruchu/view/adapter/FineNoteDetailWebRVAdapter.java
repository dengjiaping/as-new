...
public class FineNoteDetailWebRVAdapter extends BaseQuickAdapter<FineNoteWebBean.List2Bean, BaseViewHolder> {
    public FineNoteDetailWebRVAdapter(@LayoutRes int layoutResId, @Nullable List<FineNoteWebBean.List2Bean> data) {
