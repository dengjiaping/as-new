...
import com.jkpg.ruchu.view.adapter.MoreReplyFixAdapter;
...
public class MoreReplyFixActivity extends BaseActivity {
    ...
    private MoreReplyFixAdapter mMoreReplyAdapter;
    ...
    private void initRecyclerView(final List<MoreReplyBean.ItemsBean> items) {
        ...
        mMoreReplyAdapter = new MoreReplyFixAdapter(R.layout.item_reply_more_fix, items);
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, final int position) {
                switch (view.getId()) {
                    ...
                    case R.id.item_image:
                        ...
                        Intent intent = new Intent(MoreReplyFixActivity.this, FansCenterActivity.class);
...
//                                                    ToastUtils.showShort(UIUtils.getContext(),items.size()+"");
        ...
        mEditWindow.showAtLocation(MoreReplyFixActivity.this.findViewById(R.id.more_reply), Gravity.BOTTOM, 0, 0);
        // 显示键盘
