...
public class FineMoreReplyAdapter extends BaseQuickAdapter<MoreReplyBean.ItemsBean, BaseViewHolder> {
    public FineMoreReplyAdapter(@LayoutRes int layoutResId, @Nullable List<MoreReplyBean.ItemsBean> data) {
