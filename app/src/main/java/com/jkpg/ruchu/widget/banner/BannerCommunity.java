...
import com.jkpg.ruchu.widget.banner.view.BannerViewPager;
...
public class BannerCommunity extends FrameLayout implements OnPageChangeListener {
    ...
    public BannerCommunity(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.banner_community, this, true);
    ...
    public BannerCommunity isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BannerCommunity setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BannerCommunity setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BannerCommunity setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BannerCommunity setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BannerCommunity setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BannerCommunity setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BannerCommunity setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BannerCommunity setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BannerCommunity setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BannerCommunity setImages(List<?> imageUrls) {
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
     ...
     * @return
     */
    public BannerCommunity setOnBannerListener(OnBannerListener listener) {
