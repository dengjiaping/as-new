...
public class ChatImagePreviewActivity extends Activity {
    ...
    private ChatImagePreviewAdapter imagePreviewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setBackgroundResource(R.color.ic_default_bg_color);
        ...
        imagePreviewAdapter = new ChatImagePreviewAdapter(this, imageInfo);
