...
public class MultiSelectPicker extends WheelPicker {
    ...
    public MultiSelectPicker(Activity activity, List<String> firstData, List<String> secondData, List<String> thirdData) {
        super(activity);
    ...
    public void setThirdLabel(CharSequence thridPrefixLabel, CharSequence thirdSuffixLabel) {
        this.thirdPrefixLabel = thridPrefixLabel;
    ...
    public String getThirdSecondItem() {
